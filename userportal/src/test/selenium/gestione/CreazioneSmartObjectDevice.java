...
public class CreazioneSmartObjectDevice {
  ...
  @Test
  public void testCreazioneSmartObjectDevice() throws Exception {
    ...
    new Select(driver.findElement(By.id("inputType"))).selectByVisibleText("Device");
    new Select(driver.findElement(By.id("inputCategory"))).selectByVisibleText("Gateway");
    driver.findElement(By.linkText("Genera")).click();
    driver.findElement(By.id("inputVirtualentityName")).clear();
    driver.findElement(By.id("inputVirtualentityName")).sendKeys("aaTestDevice");
    driver.findElement(By.id("inputVirtualentityDescription")).clear();
    driver.findElement(By.id("inputVirtualentityDescription")).sendKeys("aaTestDescrDevice");
    driver.findElement(By.linkText("Prosegui")).click();
