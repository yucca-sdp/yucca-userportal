...
(function () {
    ...
    freeboard.loadWidgetPlugin({
        ...
        display_name: "Text",
        "external_scripts" : [
            "lib/freeboard/plugins/thirdparty/jquery.sparkline.min.js"
        ],
        settings: [
            {
                name: "title",
    ...
    freeboard.loadWidgetPlugin({
        ...
        display_name: "Gauge",
        "external_scripts" : [
            "lib/freeboard/plugins/thirdparty/raphael.2.1.0.min.js",
            "lib/freeboard/plugins/thirdparty/justgage.1.0.1.js"
        ],
        settings: [
            {
                name: "title",
