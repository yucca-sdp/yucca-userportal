...
@WebServlet(description = "Configuration language TAGS for clients", urlPatterns = { "/api/subdomains" }, initParams = { @WebInitParam(name = "language", value = "it"), }, asyncSupported = true)
public class SubDomainServiceServlet extends I18nServlet {
	...
	protected JSONArray loadMessages(Locale currentLocale) throws MalformedURLException {
		...
		try {
			...
			is = new URL(config.getProperty(Config.API_ADMIN_URL_KEY) + "/1/public/subdomains?ecosystemCode=SDNET").openStream();
...
//			{
//				"idSubdomain": 1,
//				"subdomaincode": "AGRICULTURAL_POLICIES",
//				"deprecated": 0,
//				"idDomain": 1,
//				"langEn": "Agricultural Policies",
//				"langIt": "Politiche agricole"
//				},
			
			for(int i = 0 ; i < elements.length() ; i++){
				String tagCode = elements.getJSONObject(i).getString("subdomaincode");
