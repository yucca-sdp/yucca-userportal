...
appServices.factory('webSocketService',['$rootScope','WEB_SOCKET_BASE_URL','WEB_SOCKET_USER','WEB_SOCKET_SECRET', function($rootScope,WEB_SOCKET_BASE_URL,WEB_SOCKET_USER,WEB_SOCKET_SECRET) {
	var stompClient = {};	
//	var self = this;
	var root = $rootScope;
